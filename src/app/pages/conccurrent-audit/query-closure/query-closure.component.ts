...
@Component({
  selector: 'app-query-closure',
  templateUrl: './query-closure.component.html',
  styleUrls: ['./query-closure.component.scss']
})
export class QueryClosureComponent implements OnInit {
