...
@Component({
  selector: 'app-file-checking',
  templateUrl: './file-checking.component.html',
  styleUrls: ['./file-checking.component.scss']
})
export class FileCheckingComponent implements OnInit {
  ...
  save() {
    ...
    const apiUrl = this._global.baseAPIUrl + "BranchInward/FileChecking";
