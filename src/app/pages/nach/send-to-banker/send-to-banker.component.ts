...
@Component({
  selector: 'app-send-to-banker',
  templateUrl: './send-to-banker.component.html',
  styleUrls: ['./send-to-banker.component.scss']
})
export class SendToBankerComponent implements OnInit {
  ...
  downloadFileErrorLog(data: any) {
    const filename = 'SendToBankerlog_CSV'
  ...
  downloadFile() {
    const filename = 'SendToBankerFormat_CSV';
