...
@Component({
  selector: 'app-handed-over-to-nach-team',
  templateUrl: './handed-over-to-nach-team.component.html',
  styleUrls: ['./handed-over-to-nach-team.component.scss']
})
export class HandedOverToNachTeamComponent implements OnInit {
  ...
  downloadFileErrorLog(data: any) {
    const filename = 'HandedOvertonatchteamlog_CSV'
  ...
  downloadFile() {
    const filename = 'HandedOvertonatchteamFormat_CSV';
