...
@Component({
  selector: 'app-received-by-nach-team',
  templateUrl: './received-by-nach-team.component.html',
  styleUrls: ['./received-by-nach-team.component.scss']
})
export class ReceivedByNachTeamComponent implements OnInit {
  ...
  downloadFileErrorLog(data: any) {
    const filename = 'Receivedbynatchteamlog_CSV'
  ...
  downloadFile() {
    const filename = 'ReceivedbynatchteamFormat_CSV';
