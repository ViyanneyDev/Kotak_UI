...
@Component({
  selector: 'app-repayment-loading',
  templateUrl: './repayment-loading.component.html',
  styleUrls: ['./repayment-loading.component.scss']
})
export class RepaymentLoadingComponent implements OnInit {
  ...
  downloadFile() {
    const filename = 'RepaymentLoadingFormat_CSV';
  ...
  downloadFileErrorLog(data:any) {
    const filename = 'RepaymentLoadinglog_CSV';
    // let csvData = "state,region,appl,apac,contract_no,apac_effective_date,product,location,sub_lcoation,tenure,maturity_date,maln_party_id,party_name,agr_value,eml_start_date,pdc_type";
