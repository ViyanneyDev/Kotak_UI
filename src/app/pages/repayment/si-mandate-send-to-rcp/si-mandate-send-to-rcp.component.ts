...
@Component({
  selector: 'app-si-mandate-send-to-rcp',
  templateUrl: './si-mandate-send-to-rcp.component.html',
  styleUrls: ['./si-mandate-send-to-rcp.component.scss']
})
export class SiMandateSendToRcpComponent implements OnInit {
  ...
  downloadFileErrorLog(data: any) {
    const filename = 'SIMandateSendToRpclog_CSV'
  ...
  downloadFile() {
    const filename = 'SIMandateSendToRpcFormat_CSV';
