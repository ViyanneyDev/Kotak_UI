...
@Component({
  selector: 'app-scanning-done',
  templateUrl: './scanning-done.component.html',
  styleUrls: ['./scanning-done.component.scss']
})
export class ScanningDoneComponent implements OnInit {
  ...
  downloadFileErrorLog(data: any) {
    const filename = 'ScanningDonelog_CSV'
  ...
  downloadFile() {
    const filename = 'ScanningDoneFormat_CSV';
