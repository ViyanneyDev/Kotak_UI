...
@Component({
  selector: 'app-klap-audit-complete',
  templateUrl: './klap-audit-complete.component.html',
  styleUrls: ['./klap-audit-complete.component.scss']
})
export class KlapAuditCompleteComponent implements OnInit {
...
const apiUrl = this._global.baseAPIUrl + 'Klap/getAuditCompeltedata?UserID='+localStorage.getItem('UserID')+'&user_Token='+ localStorage.getItem('User_Token');
