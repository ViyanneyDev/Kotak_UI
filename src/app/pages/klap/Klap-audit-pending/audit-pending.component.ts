...
@Component({
  ...
  styleUrls : ["audit-pending.component.css"]
})
export class AuditpendingComponent implements OnInit {
...
const apiUrl = this._global.baseAPIUrl + 'Klap/getAuditpending?UserID='+localStorage.getItem('UserID')+'&user_Token='+ localStorage.getItem('User_Token');
  ...
  SendToKlap(row:any)
{
 ...
 this.router.navigateByUrl('/klap/klap-audit');
